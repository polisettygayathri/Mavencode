...
public class ExtentReportsTestCase_Method {
	...
	public void startReport() {
		...
		htmlReporter = new ExtentHtmlReporter(
				"./test-output/extentReport/IBM_ExtentReport_final" + dateName_number + ".html");
		...
		htmlReporter.config().setDocumentTitle("IBM - Functional Automation/API Report");
		// Name of the report
	...
	public void getResult(ITestResult result) throws Exception {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			// String screenshotPath = getScreenShot(driver, result.getName());
			// logger.pass("Test Case pass Snapshot is below " +
